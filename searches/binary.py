...
def binary_search(array, key, search, action = "Update", replacement = None):
    ...
    while lowerBound != upperBound:
        ...
        focusedIndex = (lowerBound + upperBound)//2
        ...
        elif search > record[key]:
            lowerBound = focusedIndex + 1   # Index slicing starts at lowerBound
            
        else:
            upperBound = focusedIndex   # Index slicing stops at upperBound - 1
...
if __name__ == "__main__":
    ...
    heap_sort(array, 'Customer')

    tabulate_data(array)
    binary_search(array, 'Customer', 'Alice Margatroid', 'Delete')
    tabulate_data(array)
